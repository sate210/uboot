...
//#if defined NAND_BSP
#define CONFIG_NAND_SIZE_1G
//#define CONFIG_NAND_SIZE_256M
//#endif
...
#define CFG_FASTBOOT_TRANSFER_BUFFER_SIZE	(200*1024*1024)   /* 200MB */
...
#if defined(CONFIG_NAND_SIZE_1G)
#define NAND_SIZE  				(1024*1024*1024)
#elif defined(CONFIG_NAND_SIZE_256M)
#define NAND_SIZE  				(256*1024*1024)
#endif

#define BOOTLOADER_SIZE 	    (0x100000)
#define RECOVERY_SIZE			(0x500000)
#define KERNEL_SIZE 			(0x500000)
#define RAMDISK_SIZE 			(0x500000)
#define SYSTEM_SIZE				(180*1024*1024)
#define CACHE_SIZE				(0x1400000)
#define USERDATA_SIZE			(NAND_SIZE-(BOOTLOADER_SIZE+RECOVERY_SIZE+KERNEL_SIZE+RAMDISK_SIZE+SYSTEM_SIZE+CACHE_SIZE))
